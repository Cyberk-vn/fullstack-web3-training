...
import { projectId, wagmiAdapter } from "@/lib/api/config/wagmi-config";
import { queryClient } from "@/lib/api/config/query-client-config";
// SIWX functionality - uncomment when @reown/appkit-siwx is available
...
createAppKit({
  ...
  // siwx: new DefaultSIWX(), // add this line to enable SIWX when package is available
